...
GXVoid GXCALL GXCreateSkeletalMesh ( GXSkeletalMeshUnit &mesh, const GXSkeletalMeshData &data )
{
	...
	//{
		GXUInt stride = sizeof ( GXVec3 ) + sizeof ( GXVec2 ) + sizeof ( GXVec3 ) + sizeof ( GXVec3 ) + sizeof ( GXVec3 ) + sizeof ( GXVec4 ) + sizeof ( GXVec4 );

		GXUInt vertexOffset = 0;
		GXUInt uvOffset = sizeof ( GXVec3 );
		GXUInt normalOffset = uvOffset + sizeof ( GXVec2 );
		GXUInt tangentOffset = normalOffset + sizeof ( GXVec3 );
		GXUInt bitangentOffset = tangentOffset + sizeof ( GXVec3 );
		GXUInt boneOffset = bitangentOffset + sizeof ( GXVec3 );
		GXUInt weightOffset = boneOffset + sizeof ( GXVec4 );

		GXUInt size = info.numVertices * stride;
