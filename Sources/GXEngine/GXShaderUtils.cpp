...
GLuint GXCALL GXCreateTransformFeedbackShaderProgram ( const GXWChar* vFileName, const GXWChar* gFileName, const GXWChar* fFileName, GXUByte numVaryings, const GXChar** varyings, GLenum bufferMode )
{
	GLuint shaderProgram = glCreateProgram ();
	GLuint vertexShader = glCreateShader ( GL_VERTEX_SHADER );
