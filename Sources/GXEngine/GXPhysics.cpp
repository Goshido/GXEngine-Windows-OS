...
GXBool GXCALL GXPhysXInit ()
{
	...
	GXPhysicsCreate = ( PFNGXPHYSICSCREATE )GetProcAddress ( gx_GXEngineDLLModuleHandle, "?GXPhysicsCreate@@YGPAVGXPhysics@@XZ" );
	if ( !GXPhysicsCreate )
	{
	...
	GXPhysicsDestroy = ( PFNGXPHYSICSDESTROY )GetProcAddress ( gx_GXEngineDLLModuleHandle, "?GXPhysicsDestroy@@YGXPAVGXPhysics@@@Z" );
	if ( !GXPhysicsDestroy )
	{
