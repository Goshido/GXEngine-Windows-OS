...
GXBool GXCALL GXSoundInit ()
{
	...
	GXOGGVorbisInit = ( PFNGXOGGVORBISINIT )GetProcAddress ( gx_GXEngineDLLModuleHandle, "?GXOGGVorbisInit@@YGXAAUGXOGGVorbisFunctions@@@Z" );
	if ( !GXOGGVorbisInit )
	{
	...
	GXOpenALInit = ( PFNGXOPENALINIT )GetProcAddress ( gx_GXEngineDLLModuleHandle, "?GXOpenALInit@@YG_NAAUGXOpenALFunctions@@@Z" );
	if ( !GXOpenALInit )
	{
