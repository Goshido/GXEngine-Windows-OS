...
{
	GXUShort fileNameSize = sizeof ( GXWChar ) * ( wcslen ( info.fileName ) + 1 );
	GXUShort cacheFileNameSize = sizeof ( GXWChar ) * ( wcslen ( info.cacheFileName ) + 1 );
	GXUShort totalFileSize = sizeof ( GXBakeHeader ) + fileNameSize + cacheFileNameSize;
