...
enum EGXInputButtonState
{
	INPUT_DOWN,
	INPUT_UP
};

union EGXInputMouseFlags
{
	struct
	{
		GXUChar lmb 		: 1;
...
typedef GXVoid ( GXCALL* PFNGXTYPEPROC ) ( GXWChar symbol );
typedef GXVoid ( GXCALL* PFNGXKEYPROC ) ();
typedef GXVoid ( GXCALL* PFNGXMOUSEMOVEPROC ) ( GXInt win_x, GXInt win_y );
typedef GXVoid ( GXCALL* PFNGXMOUSEBUTTONSPROC ) ( EGXInputMouseFlags mouseflags );
...
class GXInput
{
	...
	public:
		...
		GXVoid BindKeyFunc ( PFNGXKEYPROC callback, GXInt vk_key, EGXInputButtonState eState );
		GXVoid UnBindKeyFunc ( GXInt vk_key, EGXInputButtonState eState );

		GXVoid BindTypeFunc ( PFNGXTYPEPROC callback );
		...
		GXVoid BindGamepadKeyFunc ( PFNGXKEYPROC callback, GXInt gamepad_key, EGXInputButtonState eState );
