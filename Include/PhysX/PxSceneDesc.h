...
public:
	...
	*/
	...
	PxCreatePhysics(). The affected tolerances are sweepEpsilonDistance, contactCorrelationDistance, and 
	bounceThresholdVelocity.

	@see PxCreatePhysics() PxTolerancesScale bounceThresholdVelocity sweepEpsilonDistance contactCorrelationDistance
	*/
