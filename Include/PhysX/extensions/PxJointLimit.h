...
public:
	...
	*/
	...
	active. For linear limits, 0.01f * PxTolerancesScale::length is often suitable, and for angular limits 0.1 radians is a typical value.
...
public:
	...
	*/
	...
	active. For linear limits, 0.01f * PxTolerancesScale::length is often suitable, and for angular limits 0.1 radians is a typical value. For small limits this may result in the limit being active all the
	time, and to prevent this use a little less than half the smaller angle, and to prevent this use a little less than half the extent of the
	limit, e.g. 0.49f*(upper-lower)
...
public:
	...
	*/
	...
	\param[in] limitContactDistance the distance from the upper or lower limit at which the limit constraint becomes
	active. 0.1f radians is a typical value, but for small limits this may result in the limit being active all the
	time, and to prevent this use a little less than half the smaller of the two angles.
