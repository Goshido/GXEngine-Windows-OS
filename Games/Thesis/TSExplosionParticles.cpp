...
TSExplosionParticles::TSExplosionParticles ( GXIdealParticleSystemParams &params ):
GXIdealParticles ( params )
{
	//NOTHING
}

GXVoid TSExplosionParticles::Draw ()
{
	if ( distribution == 0 )
...
TSExplosionParticles::~TSExplosionParticles ()
{
...
GXVoid TSExplosionParticles::Load3DModel ()
{
	GXLoadMTR ( L"../Materials/Thesis/Explosion_Particles.mtr", mat_info );
...
GXVoid TSExplosionParticles::InitUniforms ()
{
	glUseProgram ( mat_info.shaders[ 0 ].uiId );
...
GXVoid TSExplosionParticles::InitGraphicalResources ()
{
