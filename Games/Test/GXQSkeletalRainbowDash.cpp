...
GXQSkeletalRainbowDash::GXQSkeletalRainbowDash ()
{
	Load3DModel ();
	InitCharacterContent ();
}

GXVoid GXQSkeletalRainbowDash::InitCharacterContent ()
{
...
GXVoid GXQSkeletalRainbowDash::InitUniforms ()
{
...
GXVoid GXQSkeletalRainbowDash::Draw ()
{
...
GXVoid GXQSkeletalRainbowDash::Load3DModel ()
{
	GXLoadPSK ( L"../3D Models/Test/Rigged RainbowDash/RainbowDash.PSK", &skminfo );
	GXLoadMTR ( L"../Materials/Test/Rainbow_Dash.mtr", mat_info );
	GXGetTexture ( mat_info.textures[ 0 ] );
	GXGetTexture ( mat_info.textures[ 1 ] );
}

GXVoid GXQSkeletalRainbowDash::SetLocation ( GXFloat* Loc )
{
	GXMesh::SetLocation ( Loc );
}

GXVoid GXQSkeletalRainbowDash::SetLocation ( GXFloat x, GXFloat y, GXFloat z )
{
	GXMesh::SetLocation ( x, y, z );
}

GXVoid GXQSkeletalRainbowDash::SetRotation ( GXFloat* Rot_rad )
{
	GXMesh::SetRotation ( Rot_rad );
}

GXVoid GXQSkeletalRainbowDash::SetRotation ( GXQuat qt )
{
	GXMesh::SetRotation ( qt );
}

GXVoid GXQSkeletalRainbowDash::SetRotation ( GXFloat pitch_rad, GXFloat yaw_rad, GXFloat roll_rad )
{
	GXMesh::SetRotation ( pitch_rad, yaw_rad, roll_rad );
}

GXVoid GXQSkeletalRainbowDash::Update ( GXDword deltaTime )
{
