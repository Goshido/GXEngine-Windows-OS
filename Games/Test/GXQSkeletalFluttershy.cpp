...
GXQSkeletalFluttershy::GXQSkeletalFluttershy ()
{
	Load3DModel ();
	InitCharacterContent ();
}

GXVoid GXQSkeletalFluttershy::InitCharacterContent ()
{
...
GXVoid GXQSkeletalFluttershy::InitUniforms ()
{
...
GXVoid GXQSkeletalFluttershy::Draw ()
{
...
GXVoid GXQSkeletalFluttershy::Load3DModel ()
{
	GXLoadPSK ( L"../3D Models/Test/Rigged Fluttershy/Fluttershy.PSK", &skminfo );
	GXLoadMTR ( L"../Materials/Test/Fluttershy.mtr", mat_info );
	GXGetTexture ( mat_info.textures[ 0 ] );
	GXGetTexture ( mat_info.textures[ 1 ] );
}

GXVoid GXQSkeletalFluttershy::SetLocation ( GXFloat* Loc )
{
	GXMesh::SetLocation ( Loc );
}

GXVoid GXQSkeletalFluttershy::SetLocation ( GXFloat x, GXFloat y, GXFloat z )
{
	GXMesh::SetLocation ( x, y, z );
}

GXVoid GXQSkeletalFluttershy::SetRotation ( GXFloat* Rot_rad )
{
	GXMesh::SetRotation ( Rot_rad );
}

GXVoid GXQSkeletalFluttershy::SetRotation ( GXQuat qt )
{
	GXMesh::SetRotation ( qt );
}

GXVoid GXQSkeletalFluttershy::SetRotation ( GXFloat pitch_rad, GXFloat yaw_rad, GXFloat roll_rad )
{
	GXMesh::SetRotation ( pitch_rad, yaw_rad, roll_rad );
}

GXVoid GXQSkeletalFluttershy::Update ( GXDword deltaTime )
{
