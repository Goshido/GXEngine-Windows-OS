...
#ifndef GX_Q_SKELETAL_FLUTTERSHY
#define GX_Q_SKELETAL_FLUTTERSHY
...
class GXQSkeletalFluttershy : public GXSkeletalMeshQuat
{
	protected:
	...
	public:
		GXQSkeletalFluttershy ();
		virtual ~GXQSkeletalFluttershy ();
...
#endif	//GX_Q_SKELETAL_FLUTTERSHY