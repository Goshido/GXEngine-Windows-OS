...
#include "GXQSkeletalMLPCharacter.h"


GXVoid GXQSkeletalMLPCharacter::InitCharacterContent ()
{
...
GXQSkeletalMLPCharacter::~GXQSkeletalMLPCharacter ()
{
...
GXVoid GXQSkeletalMLPCharacter::InitUniforms ()
{
...
GXVoid GXQSkeletalMLPCharacter::Draw ( GXVoid* arg )
{
	...
	const GXMat4* view_proj_mat = cam->GetViewProjectionMatrixPtr ();
...
GXVoid GXQSkeletalMLPCharacter::SetLocation ( GXFloat* Loc )
{
	GXMesh::SetLocation ( Loc );
}

GXVoid GXQSkeletalMLPCharacter::SetLocation ( GXFloat x, GXFloat y, GXFloat z )
{
	GXMesh::SetLocation ( x, y, z );
}

GXVoid GXQSkeletalMLPCharacter::SetRotation ( GXFloat* Rot_rad )
{
	GXMesh::SetRotation ( Rot_rad );
}

GXVoid GXQSkeletalMLPCharacter::SetRotation ( GXQuat qt )
{
	GXMesh::SetRotation ( qt );
}

GXVoid GXQSkeletalMLPCharacter::SetRotation ( GXFloat pitch_rad, GXFloat yaw_rad, GXFloat roll_rad )
{
