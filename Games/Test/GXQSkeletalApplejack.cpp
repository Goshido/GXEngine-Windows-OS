...
GXQSkeletalApplejack::GXQSkeletalApplejack ()
{
	Load3DModel ();
	InitCharacterContent ();
}

GXVoid GXQSkeletalApplejack::InitCharacterContent ()
{
...
GXVoid GXQSkeletalApplejack::InitUniforms ()
{
...
GXVoid GXQSkeletalApplejack::Draw ()
{
...
GXVoid GXQSkeletalApplejack::Load3DModel ()
{
	GXLoadPSK ( L"../3D Models/Test/Rigged Applejack/Applejack.PSK", &skminfo );
	GXLoadMTR ( L"../Materials/Test/Applejack.mtr", mat_info );
	GXGetTexture ( mat_info.textures[ 0 ] );
	GXGetTexture ( mat_info.textures[ 1 ] );
}

GXVoid GXQSkeletalApplejack::SetLocation ( GXFloat* Loc )
{
	GXMesh::SetLocation ( Loc );
}

GXVoid GXQSkeletalApplejack::SetLocation ( GXFloat x, GXFloat y, GXFloat z )
{
	GXMesh::SetLocation ( x, y, z );
}

GXVoid GXQSkeletalApplejack::SetRotation ( GXFloat* Rot_rad )
{
	GXMesh::SetRotation ( Rot_rad );
}

GXVoid GXQSkeletalApplejack::SetRotation ( GXQuat qt )
{
	GXMesh::SetRotation ( qt );
}

GXVoid GXQSkeletalApplejack::SetRotation ( GXFloat pitch_rad, GXFloat yaw_rad, GXFloat roll_rad )
{
	GXMesh::SetRotation ( pitch_rad, yaw_rad, roll_rad );
}

GXVoid GXQSkeletalApplejack::Update ( GXDword deltaTime )
{
