...
GXVoid GXMSkeletalMLPCharacter::InitCharacterContent ()
{
...
GXMSkeletalMLPCharacter::~GXMSkeletalMLPCharacter ()
{
...
GXVoid GXMSkeletalMLPCharacter::InitUniforms ()
{
	...
	jointsLocation = GXGetUniformLocation ( mat_info.shaders [ 0 ].uiId, "joints" );
	mod_view_proj_mat_Location = GXGetUniformLocation ( mat_info.shaders [ 0 ].uiId, "mod_view_proj_mat" ); 
	glUseProgram ( 0 );
}

GXVoid GXMSkeletalMLPCharacter::Draw ( GXVoid* arg )
{
	GXCamera* cam = (GXCamera*)( (GXPointer*)arg )[ 0 ];
	GXDword deltaTime = *( (GXDword*)( (GXPointer*)arg )[ 1 ] );
	lasttime += deltaTime;
	Animate ();
	...
	glUniformMatrix4fv ( jointsLocation, skminfo.totalBones, GL_FALSE, VT->A );
...
GXVoid GXMSkeletalMLPCharacter::SetLocation ( GXFloat* Loc )
{
	GXMesh::SetLocation ( Loc );
}

GXVoid GXMSkeletalMLPCharacter::SetLocation ( GXFloat x, GXFloat y, GXFloat z )
{
	GXMesh::SetLocation ( x, y, z );
}

GXVoid GXMSkeletalMLPCharacter::SetRotation ( GXFloat* Rot_rad )
{
	GXMesh::SetRotation ( Rot_rad );
}

GXVoid GXMSkeletalMLPCharacter::SetRotation ( GXQuat qt )
{
	GXMesh::SetRotation ( qt );
}

GXVoid GXMSkeletalMLPCharacter::SetRotation ( GXFloat pitch_rad, GXFloat yaw_rad, GXFloat roll_rad )
{
