...
GXQSkeletalTwilightSparkle::GXQSkeletalTwilightSparkle ()
{
	Load3DModel ();
	InitCharacterContent ();
}

GXVoid GXQSkeletalTwilightSparkle::InitCharacterContent ()
{
...
GXVoid GXQSkeletalTwilightSparkle::Draw ()
{
...
GXVoid GXQSkeletalTwilightSparkle::SetLocation ( GXFloat* Loc )
{
	GXMesh::SetLocation ( Loc );
}

GXVoid GXQSkeletalTwilightSparkle::SetLocation ( GXFloat x, GXFloat y, GXFloat z )
{
	GXMesh::SetLocation ( x, y, z );
}

GXVoid GXQSkeletalTwilightSparkle::SetRotation ( GXFloat* Rot_rad )
{
	GXMesh::SetRotation ( Rot_rad );
}

GXVoid GXQSkeletalTwilightSparkle::SetRotation ( GXQuat qt )
{
	GXMesh::SetRotation ( qt );
}

GXVoid GXQSkeletalTwilightSparkle::SetRotation ( GXFloat pitch_rad, GXFloat yaw_rad, GXFloat roll_rad )
{
	GXMesh::SetRotation ( pitch_rad, yaw_rad, roll_rad );
}

GXVoid GXQSkeletalTwilightSparkle::Update ( GXDword deltaTime )
{
	this->deltaTime = deltaTime;
}

GXVoid GXQSkeletalTwilightSparkle::InitUniforms ()
{
	glUseProgram ( mat_info.shaders[ 0 ].uiId );
...
GXVoid GXQSkeletalTwilightSparkle::Load3DModel ()
{
	GXLoadPSK ( L"../3D Models/Test/Twily.PSK", &skminfo );
	GXLoadMTR ( L"../Materials/test/Twilight_Sparkle.mtr", mat_info );
